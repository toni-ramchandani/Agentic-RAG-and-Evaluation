...
def seed_openai_vector_store():
    ...
    console.print(f"[yellow]LLM_PROVIDER=openai[/yellow]\n")
...
def seed_chroma_vector_store():
    ...
    console.print(f"[yellow]USE_LOCAL_VECTOR_STORE=true[/yellow]")
    console.print(f"[yellow]CHROMA_PERSIST_DIR={persist_dir}[/yellow]")
    console.print(f"[yellow]LLM_PROVIDER=ollama[/yellow]\n")
